...
var ItemReorder = (function() {
    ...
    ItemReorder.prototype._scrollContent = function(scroll) {
        var contentDimensions = this._content.getContentDimensions();
        var contentTop = contentDimensions.scrollTop;
        var scrollTop = contentTop + scroll;
        if (scroll !== 0) {
    ...
    /** @nocollapse */
    ItemReorder.ctorParameters = function() {
        return [
            { type: Platform, },
            { type: DomController, },
            { type: ElementRef, },
